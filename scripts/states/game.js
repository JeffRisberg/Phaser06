define(['extensions/Monster', 'extensions/House', 'extensions/Tower', 'extensions/PausePanel'], function (Monster, House, Tower, PausePanel) {
    'use strict';
    var game;
    ...
    Game.prototype = {
        create: function () {
            ...
            //tower.events.onDragStop.add(this.onDragStop, this);
            text = "Tower";
